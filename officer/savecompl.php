              ...
              $age=$_POST['age'];
                ...
                if($errors){
                      ...
                      $output = array('error' => true, $errors);
                         ...
                         $sql = "INSERT INTO complaint(comp_name,tel,occupation,region,district,loc,addrs,age,gender) VALUES(?,?,?,?,?,?,?,?,?); ";

                   $success = $db->insertRow($sql, [$name, $tel,$occ,$region,$district,$loc,$addrs,$age,$gender]);
